...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "PORTAL JUD · Modo Corre" },
      { name: "description", content: "Plataforma exclusiva para advogados acompanharem contratos, clientes e comissões." },
      { name: "author", content: "Modo Corre" },
      { property: "og:title", content: "PORTAL JUD · Modo Corre" },
      { property: "og:description", content: "Plataforma exclusiva para advogados acompanharem contratos, clientes e comissões." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "PORTAL JUD · Modo Corre" },
